    ...
    <div class="page-container">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
        <div class="bear-card p-4 flex items-center gap-4">
          <div class="w-11 h-11 rounded-xl flex items-center justify-center" style="background:#eef2ff"><span class="material-symbols-rounded" style="color:#4f46e5">local_shipping</span></div>
        ...
        <div class="bear-card p-4 flex items-center gap-4">
          <div class="w-11 h-11 rounded-xl flex items-center justify-center" style="background:#fef2f2"><span class="material-symbols-rounded" style="color:#ef4444">cancel</span></div>
                ...
                <div class="flex gap-0.5">
                  @if (c.status === 'DIGITACAO') {
                    <button class="bear-btn bear-btn--ghost" style="padding:0.25rem 0.5rem;font-size:0.75rem;"
                      ...
                      <span class="material-symbols-rounded text-sm" style="color:#059669">send</span>
                    </button>
                  }
                  @if (c.status === 'AUTORIZADO') {
                    <button class="bear-btn bear-btn--ghost" style="padding:0.25rem 0.5rem;font-size:0.75rem;"
                            matTooltip="Cancelar" (click)="cancelar(c)">
                      <span class="material-symbols-rounded text-sm" style="color:#ef4444">cancel</span>
                    </button>
                  }
                  <button class="bear-btn bear-btn--ghost" style="padding:0.25rem 0.5rem;font-size:0.75rem;"
                          matTooltip="DACTE">
