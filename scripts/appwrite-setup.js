...
const collections = [
  ...
  },
  {
    ...
    attrs: [
      ...
      { key: 'nire', type: 'string', size: 20, required: false },
      { key: 'naturezaJuridica', type: 'string', size: 20, required: false },
      { key: 'cnae', type: 'string', size: 15, required: false },
      { key: 'codigoMunicipio', type: 'string', size: 10, required: false },
      { key: 'regimeTributario', type: 'string', size: 30, required: true },
      { key: 'tipoEstabelecimento', type: 'string', size: 10, required: false },
      { key: 'dataInicioAtividades', type: 'string', size: 10, required: false },
      ...
      { key: 'bairro', type: 'string', size: 100, required: false },
      ...
      { key: 'contadorNome', type: 'string', size: 150, required: false },
      { key: 'contadorCpf', type: 'string', size: 11, required: false },
      { key: 'contadorCrc', type: 'string', size: 20, required: false },
      { key: 'contadorCrcUf', type: 'string', size: 2, required: false },
      { key: 'responsavelNome', type: 'string', size: 150, required: false },
      { key: 'responsavelCpf', type: 'string', size: 11, required: false },
      { key: 'responsavelQualificacao', type: 'string', size: 30, required: false },
  ...
  },
  {
    ...
    attrs: [
      { key: 'nome', type: 'string', size: 255, required: true },
      { key: 'razaoSocial', type: 'string', size: 255, required: false },
      { key: 'nomeFantasia', type: 'string', size: 255, required: false },
      { key: 'cpfCnpj', type: 'string', size: 20, required: true },
      { key: 'tipo', type: 'string', size: 10, required: true },
      { key: 'inscricaoEstadual', type: 'string', size: 20, required: false },
      ...
      { key: 'uf', type: 'string', size: 2, required: false },
      { key: 'cep', type: 'string', size: 10, required: false },
      { key: 'chavePix', type: 'string', size: 255, required: false },
      { key: 'banco', type: 'string', size: 100, required: false },
      { key: 'agencia', type: 'string', size: 20, required: false },
      { key: 'conta', type: 'string', size: 30, required: false },
      { key: 'status', type: 'string', size: 20, required: true },
      { key: 'empresaId', type: 'string', size: 50, required: true },
      { key: 'tenantId', type: 'string', size: 50, required: true },
      { key: 'createdAt', type: 'string', size: 30, required: false },
  ...
  },
  {
    ...
    attrs: [
      { key: 'tipo', type: 'string', size: 10, required: true },
      { key: 'modelo', type: 'string', size: 2, required: false },
      ...
      { key: 'dataEmissao', type: 'string', size: 10, required: true },
      // Cabeçalho de operação (alimenta o motor e a apuração/SPED).
      { key: 'tipoOperacao', type: 'string', size: 10, required: false }, // ENTRADA | SAIDA
      { key: 'finalidade', type: 'string', size: 1, required: false },
      { key: 'regime', type: 'string', size: 12, required: false },
      { key: 'ufEmitente', type: 'string', size: 2, required: false },
      { key: 'ufDestino', type: 'string', size: 2, required: false },
      { key: 'consumidorFinal', type: 'boolean', required: false },
      { key: 'contribuinteIcms', type: 'boolean', required: false },
      { key: 'emitenteCnpj', type: 'string', size: 20, required: false },
      { key: 'emitenteNome', type: 'string', size: 255, required: false },
      ...
      { key: 'valorProdutos', type: 'float', required: false },
      { key: 'valorICMS', type: 'float', required: false },
      { key: 'valorICMSST', type: 'float', required: false },
      { key: 'valorFCP', type: 'float', required: false },
      { key: 'valorDifal', type: 'float', required: false },
      ...
      { key: 'valorICMSDesonerado', type: 'float', required: false },
      { key: 'valorFrete', type: 'float', required: false },
      { key: 'valorSeguro', type: 'float', required: false },
      { key: 'valorDesconto', type: 'float', required: false },
      { key: 'valorOutras', type: 'float', required: false },
  ...
  },
  {
    ...
    attrs: [
      ...
      // Perfil tributário do produto (alimenta o motor de cálculo).
      { key: 'origem', type: 'string', size: 1, required: false },
      { key: 'cstIcms', type: 'string', size: 3, required: false },
      { key: 'csosn', type: 'string', size: 3, required: false },
      { key: 'aliqIcms', type: 'float', required: false },
      { key: 'redBcIcms', type: 'float', required: false },
      { key: 'mva', type: 'float', required: false },
      { key: 'aliqIcmsSt', type: 'float', required: false },
      { key: 'aliqFcp', type: 'float', required: false },
      { key: 'cstIpi', type: 'string', size: 3, required: false },
      { key: 'aliqIpi', type: 'float', required: false },
      { key: 'cstPis', type: 'string', size: 3, required: false },
      { key: 'aliqPis', type: 'float', required: false },
      { key: 'cstCofins', type: 'string', size: 3, required: false },
  ...
  {
    // Itens (linhas) de documentos fiscais — base para apuração e SPED.
    id: 'itens_nota_fiscal',
    name: 'Itens de Nota Fiscal',
    attrs: [
      { key: 'notaId', type: 'string', size: 50, required: true },
      { key: 'numeroItem', type: 'integer', required: false },
      { key: 'produtoId', type: 'string', size: 50, required: false },
      { key: 'codigo', type: 'string', size: 60, required: false },
      { key: 'descricao', type: 'string', size: 255, required: false },
      { key: 'ncm', type: 'string', size: 10, required: false },
      { key: 'cest', type: 'string', size: 10, required: false },
      { key: 'cfop', type: 'string', size: 5, required: false },
      { key: 'unidade', type: 'string', size: 10, required: false },
      { key: 'quantidade', type: 'float', required: false },
      { key: 'valorUnitario', type: 'float', required: false },
      { key: 'valorProdutos', type: 'float', required: false },
      { key: 'desconto', type: 'float', required: false },
      { key: 'frete', type: 'float', required: false },
      { key: 'seguro', type: 'float', required: false },
      { key: 'outras', type: 'float', required: false },
      { key: 'origem', type: 'string', size: 1, required: false },
      // ICMS
      { key: 'cstIcms', type: 'string', size: 3, required: false },
      { key: 'csosn', type: 'string', size: 3, required: false },
      { key: 'baseIcms', type: 'float', required: false },
      { key: 'aliqIcms', type: 'float', required: false },
      { key: 'valorIcms', type: 'float', required: false },
      { key: 'valorIcmsDesonerado', type: 'float', required: false },
      // ICMS-ST + FCP
      { key: 'baseIcmsSt', type: 'float', required: false },
      { key: 'valorIcmsSt', type: 'float', required: false },
      { key: 'valorFcp', type: 'float', required: false },
      { key: 'valorFcpSt', type: 'float', required: false },
      { key: 'valorDifal', type: 'float', required: false },
      // IPI
      { key: 'cstIpi', type: 'string', size: 3, required: false },
      { key: 'baseIpi', type: 'float', required: false },
      { key: 'aliqIpi', type: 'float', required: false },
      { key: 'valorIpi', type: 'float', required: false },
      // PIS/COFINS
      { key: 'cstPis', type: 'string', size: 3, required: false },
      ...
      { key: 'aliqIss', type: 'float', required: false },
      { key: 'valorIss', type: 'float', required: false },
      { key: 'valorTotalItem', type: 'float', required: false },
      { key: 'empresaId', type: 'string', size: 50, required: true },
      { key: 'tenantId', type: 'string', size: 50, required: true },
      { key: 'createdAt', type: 'string', size: 30, required: false },
    ],
  ...
  {
    // Perfis de tributação aplicados por NCM/UF/operação (motor tributário).
    id: 'regras_tributarias',
    name: 'Regras Tributarias',
    attrs: [
      { key: 'nome', type: 'string', size: 120, required: true },
      { key: 'ncm', type: 'string', size: 10, required: false },
      { key: 'ufOrigem', type: 'string', size: 2, required: false },
      { key: 'ufDestino', type: 'string', size: 2, required: false },
      { key: 'tipoOperacao', type: 'string', size: 10, required: false },
      { key: 'regime', type: 'string', size: 12, required: false },
      { key: 'cfop', type: 'string', size: 5, required: false },
      { key: 'origem', type: 'string', size: 1, required: false },
      { key: 'cstIcms', type: 'string', size: 3, required: false },
...
async function populateData() {
  ...
  console.log('\n🏢 Populando Empresas...');
  const empresas = [
    { razaoSocial: 'Tech Solutions Ltda', nomeFantasia: 'TechSol', cnpj: '12.345.678/0001-90', inscricaoEstadual: 'ISENTO', nire: '35200000001', naturezaJuridica: '206-2', cnae: '6201-5/01', cnaePrincipal: '6201-5/01', codigoMunicipio: '3550308', regimeTributario: 'SIMPLES_NACIONAL', tipoEstabelecimento: 'MATRIZ', dataInicioAtividades: '2015-03-10', capitalSocial: '50000,00', endereco: 'Av. Paulista', numero: '1000', bairro: 'Bela Vista', cidade: 'São Paulo', uf: 'SP', cep: '01310-100', email: 'contato@techsol.com.br', responsavel: 'Carlos Silva', responsavelNome: 'Carlos Silva', responsavelCpf: '11122233344', responsavelQualificacao: 'SOCIO_ADMINISTRADOR', contadorNome: 'João Contábil', contadorCpf: '99988877766', contadorCrc: '1SP099999/O-9', contadorCrcUf: 'SP', status: 'ATIVA' },
    { razaoSocial: 'Comércio ABC S.A.', nomeFantasia: 'ABC Store', cnpj: '98.765.432/0001-10', inscricaoEstadual: '11.222.333', nire: '33300000002', naturezaJuridica: '205-4', cnae: '4711-3/01', cnaePrincipal: '4711-3/01', codigoMunicipio: '3304557', regimeTributario: 'LUCRO_PRESUMIDO', tipoEstabelecimento: 'MATRIZ', dataInicioAtividades: '2010-06-01', capitalSocial: '500000,00', endereco: 'Av. Rio Branco', numero: '156', bairro: 'Centro', cidade: 'Rio de Janeiro', uf: 'RJ', cep: '20040-020', email: 'financeiro@abcstore.com.br', responsavel: 'Ana Souza', responsavelNome: 'Ana Souza', responsavelCpf: '22233344455', responsavelQualificacao: 'DIRETOR', contadorNome: 'Marina Contadora', contadorCpf: '88877766655', contadorCrc: '1RJ088888/O-8', contadorCrcUf: 'RJ', status: 'ATIVA' },
    { razaoSocial: 'Indústria Metal Norte Ltda', nomeFantasia: 'MetalNorte', cnpj: '45.678.901/0001-23', inscricaoEstadual: '13.444.555', nire: '13200000003', naturezaJuridica: '206-2', cnae: '2511-0/00', cnaePrincipal: '2511-0/00', codigoMunicipio: '1302603', regimeTributario: 'LUCRO_REAL', tipoEstabelecimento: 'MATRIZ', dataInicioAtividades: '2008-11-20', capitalSocial: '2000000,00', endereco: 'Av. Torquato Tapajós', numero: '4500', bairro: 'Flores', cidade: 'Manaus', uf: 'AM', cep: '69020-010', email: 'fiscal@metalnorte.com.br', responsavel: 'Roberto Lima', responsavelNome: 'Roberto Lima', responsavelCpf: '33344455566', responsavelQualificacao: 'SOCIO_ADMINISTRADOR', contadorNome: 'Paulo Escriturador', contadorCpf: '77766655544', contadorCrc: '1AM077777/O-7', contadorCrcUf: 'AM', status: 'ATIVA' },
    { razaoSocial: 'Restaurante Sabor & Cia ME', nomeFantasia: 'Sabor & Cia', cnpj: '11.222.333/0001-44', inscricaoEstadual: 'ISENTO', nire: '31200000004', naturezaJuridica: '213-5', cnae: '5611-2/01', cnaePrincipal: '5611-2/01', codigoMunicipio: '3106200', regimeTributario: 'SIMPLES_NACIONAL', tipoEstabelecimento: 'MATRIZ', dataInicioAtividades: '2018-02-14', capitalSocial: '30000,00', endereco: 'Rua da Bahia', numero: '1200', bairro: 'Centro', cidade: 'Belo Horizonte', uf: 'MG', cep: '30130-000', email: 'adm@saborecia.com.br', responsavel: 'Maria Oliveira', responsavelNome: 'Maria Oliveira', responsavelCpf: '44455566677', responsavelQualificacao: 'TITULAR', contadorNome: 'Lucas Balancete', contadorCpf: '66655544433', contadorCrc: '1MG066666/O-6', contadorCrcUf: 'MG', status: 'ATIVA' },
    { razaoSocial: 'Construtora Edificar Ltda', nomeFantasia: 'Edificar', cnpj: '55.666.777/0001-88', inscricaoEstadual: '90.111.222', nire: '41200000005', naturezaJuridica: '206-2', cnae: '4120-4/00', cnaePrincipal: '4120-4/00', codigoMunicipio: '4106902', regimeTributario: 'LUCRO_PRESUMIDO', tipoEstabelecimento: 'MATRIZ', dataInicioAtividades: '2012-09-05', capitalSocial: '800000,00', endereco: 'Rua XV de Novembro', numero: '800', bairro: 'Centro', cidade: 'Curitiba', uf: 'PR', cep: '80010-000', email: 'contabil@edificar.com.br', responsavel: 'Pedro Santos', responsavelNome: 'Pedro Santos', responsavelCpf: '55566677788', responsavelQualificacao: 'SOCIO_ADMINISTRADOR', contadorNome: 'Sandra Razão', contadorCpf: '55544433322', contadorCrc: '1PR055555/O-5', contadorCrcUf: 'PR', status: 'ATIVA' },
  ];
