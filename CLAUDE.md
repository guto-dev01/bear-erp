...
| **P1.2** Eventos NF-e pós-emissão: cancelamento (NFeRecepcaoEvento4), CC-e, inutilização | `functions/_shared/nfe/` (soap/transmissao), `index.js`, `fiscal.service.ts` | Médio-Alto (3–5 d) |
